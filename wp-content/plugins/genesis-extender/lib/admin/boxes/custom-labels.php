...
<div id="genesis-extender-custom-options-nav-labels-box" class="genesis-extender-optionbox-outer-1col genesis-extender-all-options">
	<div class="genesis-extender-optionbox-inner-1col">
		<h3><?php _e( 'Custom Labels', 'extender' ); ?><span class="button genesis-extender-add-button add-label"><?php _e( 'Add', 'extender' ); ?></span> <span id="custom-labels-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
