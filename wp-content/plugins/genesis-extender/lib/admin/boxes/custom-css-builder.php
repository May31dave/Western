...
<div style="display:none;" id="genesis-extender-custom-css-builder" class="genesis-extender-optionbox-outer-1col">
	<div class="genesis-extender-optionbox-inner-1col">
		<h3 style="border-bottom:0;"><?php _e( 'Custom CSS Builder', 'extender' ); ?> <span id="custom-css-builder-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
		
		<div class="tooltip tooltip-400">
			<h5><?php _e( 'A CSS Building Tool', 'extender' ); ?></h5>
			
			<p>
				<?php _e( 'The Custom CSS Builder is a great little tool that can be used as a simple reference or a full blown CSS coding factory.', 'extender' ); ?>
			</p>
		</div>
			...
			<div id="genesis-extender-custom-css-builder-wrap-inner" class="bg-box">
				...
				<div id="custom-css-builder-nav-fonts-box" class="genesis-extender-all-css-builder genesis-extender-options-display">
					<p style="float:left;">
						...
						<input type="text" id="font_size" name="font_size" value="12" style="width:35px;" /><code class="genesis-extender-px-unit">px</code> (<a href="http://pxtoem.com/" target="_blank">convert px to em</a>)<br />
