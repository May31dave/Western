...
<div id="genesis-extender-custom-options-nav-widget-areas-box" class="genesis-extender-optionbox-outer-1col genesis-extender-all-options">
	<div class="genesis-extender-optionbox-inner-1col">
		<h3><?php _e( 'Custom Widget Areas', 'extender' ); ?><span class="button genesis-extender-add-button add-widget"><?php _e( 'Add', 'extender' ); ?></span> <span id="custom-widgets-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
