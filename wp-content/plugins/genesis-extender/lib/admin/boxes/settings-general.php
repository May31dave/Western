			...
			<div class="genesis-extender-optionbox-inner-2col">
				...
				<div class="bg-box">	
					...
					<div class="tooltip tooltip-500">
						...
						<p>
							<?php _e( '<strong>Finally:</strong> If you see the message "<strong>Note:</strong> The Active Child Theme is already HTML5 enabled." then this means that the currently activate Genesis Child Theme already has HTML5 enabled and therefore this option does not need to be enabled for the Genesis HTML5 markup and features to be active.'); ?>
						</p>
					</div>
				</div>
			</div>
