			...
			<div id="genesis-extender-custom-css-builder-wrap-inner" class="bg-box">
				...
				<div id="custom-css-builder-nav-fonts-box" class="genesis-extender-all-css-builder">
					<p style="float:left;">
						...
						<input type="text" id="font_size" name="font_size" value="12" style="width:35px;" /><?php _e( 'px', 'extender' ); ?><?php if( is_admin() ) { ?>(<a href="http://pxtoem.com/" target="_blank">convert px to em</a>)<?php } ?><br />
