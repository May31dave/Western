...
<div id="genesis-extender-custom-options-nav-hook-boxes-box" class="genesis-extender-optionbox-outer-1col genesis-extender-all-options">
	<div class="genesis-extender-optionbox-inner-1col">
		<h3><?php _e( 'Custom Hook Boxes', 'extender' ); ?><span class="button genesis-extender-add-button add-hook"><?php _e( 'Add', 'extender' ); ?></span> <span id="custom-hooks-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
...
?>				<div id="hook-<?php echo $hook_counter; ?>" class="genesis-extender-all-hook-boxes">
					<div class="genesis-extender-custom-hook-option">
						...
						<p>
							<textarea class="resizable genesis-extender-tabby-textarea" id="custom-hook-textarea-<?php echo $hook_counter; ?>" name="custom_hook_textarea[<?php echo $hook_counter; ?>]" style="width:780px;height:100px;text-align:left;"><?php echo $custom_hook['hook_textarea']; ?></textarea>
						</p>
					</div>
				</div>
<?php		}
	...
	?>		<div id="hook-1" class="genesis-extender-all-hook-boxes">
				<div class="genesis-extender-custom-hook-option">
					...
					<p>
						<textarea class="resizable genesis-extender-tabby-textarea" id="custom-hook-textarea-1" name="custom_hook_textarea[1]" style="width:780px;height:100px;text-align:left;"></textarea>
					</p>
				</div>
			</div>
<?php	}
