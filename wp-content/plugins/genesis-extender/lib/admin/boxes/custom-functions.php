...
<div id="genesis-extender-custom-options-nav-functions-box" class="genesis-extender-optionbox-outer-1col genesis-extender-all-options">
	<div class="genesis-extender-optionbox-inner-1col">
		...
		<div class="tooltip tooltip-400">
			...
			<h5><?php _e( 'Affect Admin?', 'extender' ); ?></h5>
			
			<p>
				<?php _e( 'By default the Custom Functions you add below will only affect the front-end of your site to help prevent accidentally "breaking" your website with some bad code. But if you\'re confident in your coding abilities you can check this box to have your functions affect the Dashboard area (back-end admin section) as well.', 'extender' ); ?>
			</p>

			<h5><?php _e( 'What If I Do "Break" My Site?', 'extender' ); ?></h5>
			
			<p>
				<?php _e( 'If you\'ve enabled the "Affect Admin" option and end up adding some code that temporarily "breaks" your site you can fix this by removing the bad code from your /wp-content/uploads/genesis-extender/plugin/custom-functions.php file.', 'extender' ); ?>
			</p>
		</div>
