...
?>
	...
	<div class="genesis-extender-optionbox-inner-1col">
		<h3 style="border:none; border-bottom:1px solid #F0F0F0; -webkit-box-shadow:none; box-shadow:none;"><?php _e( 'Genesis Extender Settings/Custom Import/Export', 'extender' ); ?></h3>
		
		<div style="width:792px; float:left; padding:10px 10px 10px 0;">
			<div style="width:50%; float:left;">
				<form method="post">
				<div class="bg-box" style="margin-right:0; margin-bottom:0; height:324px;">
