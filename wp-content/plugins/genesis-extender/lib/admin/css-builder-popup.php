		...
		<form action="/" id="css-builder-custom-css-form" name="css-builder-custom-css-form">
			...
			<div id="genesis-extender-custom-css-editor-wrap-inner" class="bg-box">
				...
				<div id="custom-css-builder-nav-css-box">
					<textarea style="-webkit-border-radius:0; border-radius:0;" wrap="off" id="genesis-extender-custom-css" name="extender[custom_css]"><?php echo genesis_extender_get_custom_css( 'custom_css' ); ?></textarea>
				</div>
