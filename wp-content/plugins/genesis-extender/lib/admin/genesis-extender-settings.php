...
?>
	<div class="wrap">
		...
		?>
			<script type="text/javascript">jQuery(document).ready(function($){ $('#genesis-extender-settings-saved').html('Plugin Settings Reset').center().fadeIn('slow');window.setTimeout(function(){$('#genesis-extender-settings-saved').fadeOut( 'slow' );}, 2222); });</script>
		<?php
		}
		...
		<h2 id="genesis-extender-admin-heading"><?php _e( 'Genesis Extender - Settings', 'extender' ); ?></h2>
		...
		<div id="genesis-extender-admin-wrap">
			...
			<div id="genesis-extender-admin-footer">
				<p>
					<a href="http://cobaltapps.com" target="_blank">CobaltApps.com</a> | <a href="http://extendersupport.cobaltapps.com/" target="_blank">Resources</a> | <a href="http://cobaltapps.com/my-account/" target="_blank">My Account</a> | <a href="http://cobaltapps.com/forum/" target="_blank">Community Forum</a> | <a href="http://cobaltapps.com/affiliates/" target="_blank">Affiliates</a> &middot;
					<a><span id="show-options-reset" class="genesis-extender-custom-fonts-button button" style="margin:0; float:none !important;"><?php _e( 'Plugin Settings Reset', 'extender' ); ?></span></a>
				</p>
			</div>
			
			<div style="display:none; position:inherit; height:25px; width:520px; margin:-11px 0 0 135px; float:left;" id="show-options-reset-box" class="genesis-extender-custom-fonts-box">
				<form style="width:520px; float:left;" id="genesis-extender-reset-plugin-settings" method="post">
					<strong><?php _e( '**This Will Reset ALL Your Genesis Extender Settings**', 'extender' ); ?></strong>
					<input style="background:#D54E21; width:160px !important; color:#FFFFFF !important; -webkit-box-shadow:none; box-shadow:none;" type="submit" value="<?php _e( 'Reset Plugin Settings', 'extender' ); ?>" class="genesis-extender-reset button" name="Submit" onClick='return confirm("<?php _e( 'Are you sure your want to reset your Genesis Extender Settings?', 'extender' ); ?>")'/><input type="hidden" name="action" value="reset" />
				</form>
			</div>
		</div>
	</div> <!-- Close Wrap -->
...
//end lib/admin/genesis-extender-settings.php