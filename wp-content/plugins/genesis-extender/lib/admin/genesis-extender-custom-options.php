...
?>
	<div class="wrap">
		...
		?>
			<script type="text/javascript">jQuery(document).ready(function($){ $('#genesis-extender-custom-saved').html('Custom Options Reset').center().fadeIn('slow');window.setTimeout(function(){$('#genesis-extender-custom-saved').fadeOut( 'slow' );}, 2222); });</script>
		<?php
		}
		...
		<h2 id="genesis-extender-admin-heading"><?php _e( 'Genesis Extender - Custom Options', 'extender' ); ?></h2>
		...
		<div id="genesis-extender-admin-wrap">
			...
			<div id="genesis-extender-admin-footer">
				<p>
					...
					<a><span id="show-options-reset" class="genesis-extender-custom-fonts-button button" style="margin:0; float:none !important;"><?php _e( 'Custom Options Reset', 'extender' ); ?></span></a>
				</p>
			</div>
			...
			<div style="display:none; position:inherit; height:25px; width:520px; margin:-11px 0 0 135px; float:left;" id="show-options-reset-box" class="genesis-extender-custom-fonts-box">
				<form style="width:520px; float:left;" id="genesis-extender-reset-custom-options" method="post">
					<strong><?php _e( '**This Will Reset ALL Your Extender Custom Options**', 'extender' ); ?></strong>
...
//end lib/admin/genesis-extender-custom-options.php