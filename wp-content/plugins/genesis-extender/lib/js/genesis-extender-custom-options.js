...
jQuery(document).ready(function($){
	...
	function show_message(response) {
		...
		$('#genesis-extender-custom-saved').html(response).center().fadeIn('slow');
	...
	$('.add-widget').click(function () { 
		widget_counter += 1;
		$('#genesis-extender-widgets-wrap').prepend('<div id="widget-' + widget_counter + '"><div class="genesis-extender-custom-widget-option"><p class="bg-box-design"><span>' + e_name + '</span> <input type="text" id="custom-widget-id-' + widget_counter + '" name="custom_widget_ids[' + widget_counter + ']" value="" style="width:275px;" class="forbid-chars forbid-caps" /> <span>' + e_hook + '</span> <select id="custom-widget-hook-' + widget_counter + '" name="custom_widget_hook[' + widget_counter + ']" size="1" style="width:250px;">' + f_genesis_extender_list_hooks + '</select> <span>' + e_priority + '</span> <input type="text" id="custom-widget-priority-' + widget_counter + '" name="custom_widget_priority[' + widget_counter + ']" value="10" style="width:30px;" /> | <select id="custom-widget-status-' + widget_counter + '" class="custom-widget-status" name="custom_widget_status[' + widget_counter + ']" ><option value="hkd">' + e_hooked + '</option><option value="sht">' + e_shortcode + '</option><option value="bth">' + e_both + '</option><option value="no">' + e_deactivate + '</option></select></p><p><span>' + e_conditionals + '</span> <select class="conditionals-list-multiselect" id="custom-widget-conditionals-list-' + widget_counter + '" name="custom_widget_conditionals_list[' + widget_counter + '][]" multiple="multiple" style="width:250px;">' + f_genesis_extender_list_conditionals + '</select> <span>' + e_class + '</span> <input type="text" id="custom-widget-class-' + widget_counter + '" name="custom_widget_class[' + widget_counter + ']" value="" style="width:250px;" /> <span id="' + widget_counter + '" class="button delete-widget">' + e_delete + '</span></p></div></div>' );
