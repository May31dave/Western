...
jQuery(document).ready(function($) {
	...
	var css_editor_toggle_handler = function (event) {
		...
		if( clickCounter == 0 ) {
			...
			$('#genesis-extender-custom-css-editor').animate({"width": "show"}, { duration: 300 });
			$('#genesis-extender-custom-css-builder-nav').animate({"height": "show"}, { duration: 300 });
			var css_editor_h3_draggable_mouseenter = function() {
				$("#genesis-extender-custom-css-editor").draggable();
				$("#genesis-extender-custom-css-editor").draggable( "enable" );
			};
			var css_editor_h3_draggable_mouseleave = function() {			
				$("#genesis-extender-custom-css-editor").draggable( "disable" );
			};
			$("#genesis-extender-custom-css-editor").addClass("css-editor-draggable");
			...
			$('#genesis-extender-custom-css-editor').animate({"width": "hide"}, { duration: 300 });
			$('#genesis-extender-custom-css-builder-nav').animate({"height": "hide"}, { duration: 300 });
			clickCounter = 0;
		}
	...
	$("#css-builder-custom-css-only").one('click', function() {
		var custom_css_length = $('#genesis-extender-custom-css').val().length;
		$('#genesis-extender-custom-css').selectRange(custom_css_length,custom_css_length);
		$('#genesis-extender-custom-css').focus();
	});
	
	function css_editor_activate() {
		$('#custom-css-echo').html('');

		$("#genesis-extender-custom-css-builder-nav").addClass('css-builder-element');
		$("#genesis-extender-custom-css-builder-nav *").addClass('css-builder-element');
		$("#genesis-extender-custom-css-editor").addClass('css-builder-element');
		$("#genesis-extender-custom-css-editor *").addClass('css-builder-element');
		...
		$('#genesis-extender-custom-css').keyup(function() {
			$('#genesis-extender-floating-save-warning').html('<span>Your Changes Are Unsaved</span>');
		});

		$('#genesis-extender-floating-save').click(function() {
			$('#genesis-extender-floating-save-warning').html('');
		});
		
		function show_message(response) {
			$('#ajax-save-throbber').hide();
			$('#ajax-save-no-throb').show();
			$('#genesis-extender-css-builder-saved').html(response).fadeIn('slow');
			window.setTimeout(function(){
				$('#genesis-extender-css-builder-saved').fadeOut('slow'); 
			}, 2222);
		}
		...
		function css_builder_custom_css_change() {
			var custom_css = $('#genesis-extender-custom-css').val();
		...
		$('#genesis-extender-custom-css').bind('keyup paste', function(e) {
			if (e.type == 'paste') {
	...
	var css_builder_toggle_handler = function (event) {
		...
		if( clickCounter == 0 ) {
			...
			$('#genesis-extender-custom-css-builder').animate({"width": "show"}, { duration: 300 });
			$('#genesis-extender-custom-css-builder-nav').animate({"height": "show"}, { duration: 300 });
			clickCounter = 1;
		} else {
			$('body').removeClass("css-builder-body-nav css-builder-body-builder");
			$('#genesis-extender-custom-css-builder').animate({"width": "hide"}, { duration: 300 });
			$('#genesis-extender-custom-css-builder-nav').animate({"height": "hide"}, { duration: 300 });
			clickCounter = 0;
		}
	...
	function css_builder_activate() {
		...
		function css_builder_element_labels_append() {
			...
			$('.genesis-extender-widget-area').css('position', 'relative').append('<img id="customwidget-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/customwidget-elements-label.png" title=".genesis-extender-widget-area" />');
		...
		var show_hide_builder_sidebar_toggle_handler = function (event) {
			...
			if( clickCounter == 0 ) {
				$('#genesis-extender-custom-css-builder-wrap-inner').animate({"width": "hide"}, { duration: 300 });
				$('#genesis-extender-custom-css-builder').css('width', '0');
				$('#genesis-extender-optionbox-inner-1col').css('width', '0');
				$('#genesis-extender-custom-css-builder-wrap').css('width', '0');
				$('body').removeClass("css-builder-body-builder");
				css_builder_custom_css_change2();
				clickCounter = 1;
			} else {
				$('#genesis-extender-custom-css-builder-wrap-inner').animate({"width": "show"}, { duration: 300 });
				$('#genesis-extender-custom-css-builder').css('width', '304px');
				$('#genesis-extender-optionbox-inner-1col').css('width', '304px');
				$('#genesis-extender-custom-css-builder-wrap').css('width', '302px');
		...
		var css_builder_toggle_css_handler = function() {
			$('#genesis-extender-custom-css').animate({ height: '200px' }, 300);
		...
		$('#genesis-extender-custom-css').bind("focus", css_builder_toggle_css_handler);

		var css_builder_toggle_editor_handler = function() {
			$('#custom-css-popout-link').show("css-builder-display");
			$('#genesis-extender-custom-css').animate({ height: '50px' }, 300);
		...
		var css_editor_popout_handler = function() {
			...
			$('#genesis-extender-custom-css-editor-wrap-inner').css("width", "608px");
			$('#genesis-extender-custom-css').unbind("focus", css_builder_toggle_css_handler);
			$('#css-builder-output').unbind("focus", css_builder_toggle_editor_handler);
			$('#genesis-extender-custom-css').animate({ height: '300px', width: '630px' }, 300);
		...
		var css_editor_popin_handler = function() {
			...
			$('#genesis-extender-custom-css-editor-wrap-inner').css("width", "280px");
			$('#genesis-extender-custom-css').bind("focus", css_builder_toggle_css_handler);
			$('#css-builder-output').bind("focus", css_builder_toggle_editor_handler);
			$('#genesis-extender-custom-css').animate({ height: '50px', width: '280px' }, 300);
			$('#css-builder-output').animate({ height: '200px' }, 300);
			$("#genesis-extender-custom-css-editor").removeClass("css-editor-draggable");
		...
		$("#genesis-extender-custom-css-builder-nav").addClass('css-builder-element');
		$("#genesis-extender-custom-css-builder-nav *").addClass('css-builder-element');
		$("#genesis-extender-custom-css-builder-wrap").addClass('css-builder-element');
		$("#genesis-extender-custom-css-builder-wrap *").addClass('css-builder-element');
		$("#genesis-extender-custom-css-editor").addClass('css-builder-element');
		$("#genesis-extender-custom-css-editor *").addClass('css-builder-element');
		$("#css-builder-h3").addClass('css-builder-element');
	...
	$("#genesis-extender-custom-css").tabby();
	/***
		END Builder and Editor Only
										***/
