...
function genesis_extender_listimages()
{
	...
	$dir_handle = is_dir( $genesis_extender_uploader_settings['uploadpath'] ) ? opendir( $genesis_extender_uploader_settings['uploadpath'] ) : $images_path_broken = true;
...
//end lib/functions/genesis-extender-image-uploader.php