...
genesis_register_sidebar( array (
	' . $single_quote . 'name' . $single_quote . '			=>	__( ' . $single_quote . $widget_bits['widget_name'] . $single_quote . ', ' . $single_quote . 'extender' . $single_quote . ' ),
...
';
			...
			{
				$genesis_extender_widget_areas .= '
add_shortcode( ' . $single_quote . $widget_bits['widget_name'] . $single_quote . ', ' . $single_quote . 'genesis_extender_' . $widget_bits['widget_name'] . '_widget_area_shortcode' . $single_quote . ' );
function genesis_extender_' . $widget_bits['widget_name'] . '_widget_area_shortcode() {';
				$genesis_extender_widget_areas .= '
	ob_start();
	genesis_extender_' . $widget_bits['widget_name'] . '_widget_area_content();
...
';
			...
			{
				$genesis_extender_widget_areas .= '
add_action( ' . $single_quote . $widget_bits['hook_location'] . $single_quote . ', ' . $single_quote . 'genesis_extender_' . $widget_bits['widget_name'] . '_widget_area' . $single_quote . ', ' . $widget_bits['priority'] . ' );
function genesis_extender_' . $widget_bits['widget_name'] . '_widget_area() {';
				$genesis_extender_widget_areas .= '
	genesis_extender_' . $widget_bits['widget_name'] . '_widget_area_content();
}
';
			...
			$genesis_extender_widget_areas .= '
function genesis_extender_' . $widget_bits['widget_name'] . '_widget_area_content() {';
	...
	' . $tab . 'genesis_widget_area( ' . $single_quote . $widget_bits['widget_name'] . $single_quote . ', $args = array (
		' . $tab . $single_quote . 'before' . $single_quote . '              => ' . $single_quote . '<div id="' . $widget_bits['widget_name'] . '" class="widget-area genesis-extender-widget-area' . $widget_bits['class'] . '">' . $single_quote . ',
 ...
 * @since 1.0
 */
function genesis_extender_update_widgets( $names = '', $conditionals = '', $hooks = '', $classes = '', $statuses = '', $priorities = '' )
{
	$genesis_extender_widgets = get_option( 'genesis_extender_custom_widget_areas' );
	$these_widgets = array();
...
//end lib/functions/genesis-extender-widget-areas.php