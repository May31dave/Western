...
function sp_footer_creds_text() {
	...
	echo 'Copyright &copy; ';
	echo date('Y');
	echo ' &middot; Western Paper Box Co. &middot; All Rights Reserved &middot; Built on the <a href="http://www.studiopress.com/features" title="Genesis Framework">Genesis Framework</a> &middot; By <a href="http://www.lunchboxdesign.ca/">Lunchbox Design &middot;</a> <a href="http://lunchboxdesign.ca/WPBOX/wp-admin/">Admin</a>';
	echo '</p></div>';
}
